...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("multiplyByFour(2): " + multiplyByFour.multiply(2));
        System.out.println("multiplyByThree(1): " + multiplyByThree.multiply(1));
        System.out.println("multiplyByFour(1): " + multiplyByFour.multiply(1));
    }
}
